...
(async () => {
  ...
  await fs.writeFile("ulcerative-colitis-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("ulcerative-colitis-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
